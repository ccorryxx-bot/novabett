    ...
    <div class="px-4 pt-6 space-y-6 relative z-10">
      ...
      <div v-if="activeTab === 0">
        ...
        <div class="bg-[#111d26] border border-cyan-500/10 rounded-2xl p-5 mt-4">
          ...
          <div class="space-y-2 max-h-64 overflow-y-auto">
            <p v-if="downlineUsers.length === 0" class="text-center text-gray-500 py-6">No downline yet. Share your referral link to invite players.</p>
      ...
      <div v-else-if="activeTab === 2" class="bg-[#111d26] border border-cyan-500/10 rounded-2xl p-5">
        ...
        <div class="space-y-3 text-gray-400 text-sm">
          <p class="text-center py-4">No data available yet.</p>
        </div>
      </div>

      <!-- Tab 3: Downline Details (empty) -->
      <div v-else-if="activeTab === 3" class="bg-[#111d26] border border-cyan-500/10 rounded-2xl p-5">
        ...
        <p class="text-center text-gray-500 py-4">No downline details available.</p>
      </div>

      <!-- Tab 4: Search Downline (empty) -->
      <div v-else-if="activeTab === 4" class="bg-[#111d26] border border-cyan-500/10 rounded-2xl p-5">
        ...
        <p class="text-center text-gray-500 py-4 text-sm">{{ searchUsername ? $t('notFound') : 'Enter username to search' }}</p>
      </div>
    </div>

    <!-- Bottom Nav (SVG icons, i18n) -->
...
// Empty downline data (real data will be filled from backend later)
